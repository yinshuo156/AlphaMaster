# Genetic-Alpha generated factor 5
import numpy as np
import pandas as pd

def calculate_factor(stock_data):
    # Factor generated by Genetic-Alpha
    # Original expression: ifcondition_ge(close, open, low, high)
    ...
    try:
        factor_value = ifcondition_ge(stock_data['close'], stock_data['open'], stock_data['low'], stock_data['high'])
